...
CREATE TABLE `tblPayment` (
  ...
  PRIMARY KEY (`payID`,`payTimeExpired`),
...
INSERT INTO `tblPayment` VALUES (7,9,NULL,NULL,6,'2014-10-22 09:27:54','2014-11-22 09:27:54',10,2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tblPayment_BINS` 
BEFORE INSERT ON `tblPayment` FOR EACH ROW
Begin
...
INSERT INTO `tblPaymentType` VALUES (1,'Company','Monthly',30,15,1),(3,'Company','Quarterly',90,40,1),(4,'Advertise','Monthly',30,15,1),(5,'Advertise','Quarterly',90,40,1),(9,'Driver','Monthly',30,10,1);
...
-- Dump completed on 2014-11-22 17:49:59
